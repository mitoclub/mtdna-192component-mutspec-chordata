...
AB = read.table('../../data/abasic_sites/AbasicSitesMtDNAcontext_HLcompare.csv', sep = ';', header=TRUE)
head(AB)
```
<br>
<br>
...
ggplot(AB, aes(avgL, avgH, label = origtriH)) +
  ...
  geom_abline(slope = 1,
              ...
              linetype = "dashed")
# png("mtcars.png")
ggsave("../../pictures/abasic_sites/h_vs_l.pdf", device = "pdf", width = 12, height = 12)
```
<br>
<br>
<br>
